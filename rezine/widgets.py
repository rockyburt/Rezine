...
"""
    ...
    own.  Widgets are, in the context of Rezine, classes that have a
...
"""
from rezine.application import render_template
from rezine.models import Post, SummarizedPost, Category, Tag, Comment
