...
"""
    ...
    This module binds all the endpoints specified in `rezine.urls` to
...
"""
from rezine.views import blog, account, admin
...
all_views = {
    ...
    'account/about_rezine':       account.about_rezine,
...
#: the privileges for these content types are defined in rezine.privileges
