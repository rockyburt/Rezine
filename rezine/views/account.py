...
from rezine.forms import LoginForm, DeleteAccountForm, EditProfileForm, \
     make_notification_form
from rezine.i18n import _
from rezine.models import Comment
from rezine.privileges import ENTER_ADMIN_PANEL
from rezine.utils.account import flash, require_account_privilege
from rezine.utils.http import redirect_back, redirect_to
...
def about_rezine(request):
    """Just show the rezine license and some other legal stuff."""
    return render_account_response('account/about_rezine.html',
                                   'system.about')
