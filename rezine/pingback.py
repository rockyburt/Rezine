...
"""
    ...
    Note that pingback support is implemented in the `Rezine` core and
    ...
    in the `Rezine` core.  Neither do we handle incoming trackbacks, nor
...
from rezine.api import get_request, get_application, url_for, db, _
from rezine.models import Post, Comment
from rezine.utils.exceptions import UserException
from rezine.utils.xml import XMLRPC, Fault, strip_tags
from rezine.utils.net import open_url, NetException
