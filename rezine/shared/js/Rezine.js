/**
 * Default Rezine JavaScript Driver File
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 *
 * Part of the Rezine core framework. Provides default script
...
var Rezine = {
  ...
  gettext : function(string) {
    var translated = Rezine.TRANSLATIONS[string];
  ...
  ngettext: function(singular, plural, n) {
    var translated = Rezine.TRANSLATIONS[singular];
    if (typeof translated == 'undefined')
      return (n == 1) ? singular : plural;
    return translated[Rezine.PLURALEXPR(n)];
  },
