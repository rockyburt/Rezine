# -*- coding: utf-8 -*-
"""
    rezine.plugins.typography
    ~~~~~~~~~~~~~~~~~~~~~~~

    This plugin adds automatic typography support to Rezine.  This probably
...
from rezine.utils.admin import require_admin_privilege, flash
...
_rules = [
    ...
    (re.compile(r'(?:^|\W)\d+(")(?u)'), 'inch', u'″'),
    (re.compile(r'(?:^|\W)\d+(\')(?u)'), 'foot', u'′'),
