...
from rezine.utils.zeml import RootElement, Element, MarkupErrorElement


macros_set_up = False
macros = {}

macro_result = QName('http://rezine.pocoo.org/#creolehack}macro-result')
MACRO_SIGNAL = object()
...
rezinecreole = create_dialect(creole11_base, wiki_links_base_url=u'',
