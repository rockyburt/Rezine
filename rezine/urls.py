...
def make_urls(app):
    """Make the URLs for a new rezine application."""
    blog_urls = [
        ...
        Submount(app.cfg['account_url_prefix'], [
            ...
            Rule('/system/about', endpoint='account/about_rezine'),
    ...
    admin_urls = [
        ...
        Rule('/login', endpoint='admin/login', redirect_to='account/login'),    # XXX: Remove on Rezine 0.3
        Rule('/logout', endpoint='admin/logout', redirect_to='account/logout'), # XXX: Remove on Rezine 0.3
        ...
        Rule('/change_password', endpoint='admin/change_password',
             redirect_to='account/index'),   # XXX: Remove on Rezine 0.3
    ]
    other_urls = [
