...
"""
    ...
    The form classes the rezine core uses.
...
from rezine.i18n import _, lazy_gettext, list_languages
from rezine.application import get_application, get_request, emit_event
from rezine.config import DEFAULT_VARS
from rezine.database import db, posts
from rezine.models import User, Group, Comment, Post, Category, Tag, \
...
from rezine.parsers import render_preview
from rezine.privileges import bind_privileges
from rezine.notifications import send_notification_template, NEW_COMMENT, \
     COMMENT_REQUIRES_MODERATION
from rezine.utils import forms, log, dump_json
from rezine.utils.http import redirect_to
from rezine.utils.validators import ValidationError, is_valid_email, \
     is_valid_url, is_valid_slug, is_not_whitespace_only
from rezine.utils.redirects import register_redirect, change_url_prefix
...
class DeleteGroupForm(_GroupBoundForm):
    ...
    action = forms.ChoiceField(lazy_gettext(u'What should Rezine do with users '
...
class DeleteUserForm(_UserBoundForm):
    ...
    action = forms.ChoiceField(lazy_gettext(u'What should Rezine do with posts '
...
def make_import_form(blog):
    user_choices = [('__rezine_create_user', _(u'Create new user'))] + [
    ...
    class _ImportForm(forms.Form):
        ...
        def perform_import(self):
            from rezine.importers import perform_import
