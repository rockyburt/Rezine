...
from rezine.utils.xml import escape
from rezine.utils.text import increment_string
from rezine.models import COMMENT_MODERATED, STATUS_PUBLISHED
from rezine.privileges import BLOG_ADMIN, ENTER_ADMIN_PANEL, require_privilege
...
def rewrite_import(app, id, callback, title='Modified Import'):
    ...
    `app` can either be a `Rezine` object that is also bound to the active
...
from rezine.importers.wordpress import WordPressImporter
from rezine.importers.feed import FeedImporter
