...
"""
    ...
    handle intelligent backredirects (via :mod:`rezine.utils.http`) and supports
...
from rezine.application import get_request, url_for
from rezine.database import db
from rezine.i18n import _, ngettext, lazy_gettext, parse_datetime, \
     format_system_datetime
from rezine.utils.http import get_redirect_target, _redirect, redirect_to
from rezine.utils.validators import ValidationError
from rezine.utils.datastructures import OrderedDict, missing
...
class Widget(_Renderable):
    ...
    `name` gives you the name of the field for form submissions:
        ...
        Please keep in mind that the name is not always that obvious.  Rezine
