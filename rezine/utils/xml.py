...
from rezine.i18n import _TranslationProxy
...
def generate_rsd(app):
    ...
    from rezine.application import url_for
    ...
    attributes = [('engineName', 'Rezine'),
                  ('engineLink', 'http://rezine.pocoo.org/'),
...
class AtomFeed(BaseAtomFeed):
    ...
    import rezine
    default_generator = ('Rezine', rezine.__url__, rezine.__version__)
    del rezine
...
class Namespace(object):
    ...
    >>> ns = Namespace('http://rezine.pocoo.org/')
    >>> ns.foo
    u'{http://rezine.pocoo.org/}foo'
    """
